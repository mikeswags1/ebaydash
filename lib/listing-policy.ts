...
const RESTRICTED_ITEM_RULES: PolicyRule[] = [
  ...
  { code: 'drugs_restricted', reason: 'Drugs, nicotine, controlled substances, and ingestible health products are blocked from automated listing.', pattern: /\b(prescription|rx only|controlled substance|nicotine|vape|e-?cig|tobacco|cigar|cannabis|cbd|thc|kratom|ozempic|insulin|testosterone|steroid|vitamin|supplement|collagen peptides|magnesium glycinate|elderberry)\b/i },
