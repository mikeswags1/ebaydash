...
const RESTRICTED_ITEM_RULES: PolicyRule[] = [
  ...
  { code: 'drugs_restricted', reason: 'Ingestible health products, supplements, and vitamins are blocked from automated listing.', pattern: /\b(prescription|rx only|controlled substance|nicotine|vape|e-?cig|tobacco|cigar|cannabis|cbd|thc|kratom|ozempic|insulin|testosterone|steroid|vitamin|multivitamin|multi.vitamin|supplement|dietary supplement|softgel|gummy|gummies|capsule|omega.?3|omega.?6|fish oil|probiotic|prebiotic|collagen|magnesium|elderberry|melatonin|biotin|zinc tablet|iron supplement|turmeric|ashwagandha|whole food|superfood|nutrient.dense|immune support|energy support|daily multi|minerals|protein powder|whey protein|creatine|pre.workout|post.workout)\b/i },
