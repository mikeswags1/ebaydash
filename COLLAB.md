...
|------|-------|---------------|-----------|
| 2026-05-08 | Cursor | **“Get our app”** on **desktop dashboard**: lives in **left sidebar** (below “Operations Dashboard”, above eBay status). **Compact / PWA shell**: banner stays **under the top bar** in main content (sidebar hidden). Same dismiss key / `?installHint=1` as before. | `app/dashboard/components/DashboardSidebar.tsx`, `app/dashboard/page.tsx`, `GetTheAppBannerInner.tsx`, `globals.css`, `COLLAB.md` |
